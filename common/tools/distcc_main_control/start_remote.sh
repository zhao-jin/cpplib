...
# Date        : Mar 20, 2012
#
# Description : This script is used to start one distccd daemon remotely
...
./run_remote.exp $re_ip $re_ssh_port $re_user $re_passwd "cd ${script_base} && sh ./start_distcc.sh"
